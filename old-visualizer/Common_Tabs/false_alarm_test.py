...
from PySide6.QtWidgets import QPushButton, QSizePolicy, QHeaderView, QTableWidget, QTableWidgetItem, QGroupBox, QGridLayout, QLabel, QWidget, QVBoxLayout, QTabWidget, QComboBox, QCheckBox, QSlider, QFormLayout, QLineEdit, QPushButton
